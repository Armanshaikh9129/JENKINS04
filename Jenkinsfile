        ...
        stage('Docker Image pull tag push to qa') {
            ...
            steps {
                ...
                script {
                    ...
                    //pushing an image 
                    docker.withRegistry('https://registry.hub.docker.com/armansk9129', 'DOCKER/QA') {
        ...
        stage('Docker Image pull tag push to stage') {
            ...
            steps {
                ...
                script {
                    ...
                    //pushing an image 
                    docker.withRegistry('https://registry.hub.docker.com/armansk9129', 'DOCKER/STAGE') {
        ...
        stage('Docker Image pull tag push to prod') {
            ...
            steps {
                ...
                script {
                    ...
                    //pushing an image 
                    docker.withRegistry('https://registry.hub.docker.com/armansk9129', 'DOCKER/PROD') {
